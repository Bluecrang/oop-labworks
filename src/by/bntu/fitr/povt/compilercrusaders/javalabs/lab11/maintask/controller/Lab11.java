...
import by.bntu.fitr.povt.compilercrusaders.javalabs.lab11.maintask.logic.BookContainerLogic;
...
public class Lab11 {
	...
	public static void main(String[] args) {
		...
		while (active) {
			...
			printer.println("12 - exit");
			
			try {
				int choice = input.nextIntInRange(1, 12);
